...
- 🧠 **YandexGPT-анализ**: Автоматическая классификация (`электрика` / `сантехника` / `техническое` / `другое`)
...
- 📢 **Генерация контента**: Команда `/post` → ИИ создаёт пост для канала по вводным
...
# /post Тема: "Техработы 15 мая" → ИИ создаёт текст поста
...
**Разработчик:** Нечипоренко Руслан  
📞 +7 (916) 734-01-04  
📧 7340104@gmail.com  
